...
//
//        System.out.println(intRef == intRef1);                     //true, ссылки равны, так как хрянятся в pool
//        System.out.println(doubleRef == doubleRef1);              //false, потому что Double не хранятся в pool
